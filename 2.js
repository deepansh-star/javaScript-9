...
const student1 = new Student('Lakhan ', 'lakhan@gmail.com');
const student2 = new Student('Akhlesh', 'akhlesh@gmail.com');

admissionOffice.enrollStudent(student1); 
admissionOffice.enrollStudent(student2); 

admissionOffice.assignCourse(student1, 'Full Stack Web Development 2.0'); 
